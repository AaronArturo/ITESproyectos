...
$select = "select * from publicaciones";
    ...
    <div class="row">
        <div class="col-2 fondo_barra_lateral">
            ...
            <nav class="nav flex-column margin">
                <a class="nav-link texto_color" href="../php/pagina_inicio.php">Inicio</a>
                ...
                <a class="nav-link texto_color" href="html/calendario.html">calenadrio</a>
        ...
        <div class="col-10">
            <div class="container fondo_titulo texto_centrado">
                <div class="col-12">
                    <h2 class="texto_color">Bienvenido a tu sistema gestor educativo</h2>
                </div>
            </div>  
            <div class="container">
                <div class="row">
